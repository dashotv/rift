...
OTO := $(GOBIN)/oto-v0.14.4
$(OTO): $(BINGO_DIR)/oto.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
	@echo "(re)installing $(GOBIN)/oto-v0.14.4"
	@cd $(BINGO_DIR) && GOWORK=off $(GO) build -mod=mod -modfile=oto.mod -o=$(GOBIN)/oto-v0.14.4 "github.com/pacedotdev/oto"
